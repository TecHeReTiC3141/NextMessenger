        ...
        <div className="drawer drawer-end">
            ...
            <div className="drawer-content">
                ...
                <div className="flex w-full py-2 px-4 lg:px-6 border-b border-neutral shadow-md  items-center gap-3">
                    ...
                    <label htmlFor="profile-drawer-toggle" className="rounded-full p-2 hover:bg-sky-100 cursor-pointer">
            ...
            <div className="drawer-side z-50">
                <label htmlFor="profile-drawer-toggle" aria-label="close sidebar" className="drawer-overlay"></label>
